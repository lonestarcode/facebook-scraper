"""Health check configuration for the processor service"""
...
class HealthCheck:
    ...
    def __init__(self, service_name: str):
        ...
        self.details = {
            ...
            "kafka-consumer": "Not initialized",
    ...
    def get_health(self) -> HealthStatus:
        ...
        core_components = ["service", "database", "kafka-consumer"]
    ...
    def is_ready(self) -> bool:
        ...
        """
        required_components = ["service", "database", "kafka-consumer"]
    ...
    def kafka_status(self) -> Dict[str, bool]:
        """Get the status of Kafka components
        
        Returns:
            A dictionary mapping Kafka components to their statuses
        """
        return {
            "consumer": self.checks.get("kafka-consumer", False),
            "producer": self.checks.get("kafka-producer", False)
        }

def create_health_check(service_name: str = "processor-service") -> HealthCheck:
...
def setup_health_checks(app: FastAPI, health_check: HealthCheck) -> None:
    ...
    async def kafka_status():
        """Get the status of Kafka components"""
        return {
            "kafka": health_check.kafka_status(),
            "details": {
                "consumer": health_check.details.get("kafka-consumer", "Unknown"),
                "producer": health_check.details.get("kafka-producer", "Unknown")
            }
        }
